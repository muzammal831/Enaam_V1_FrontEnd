...
function AddVideo() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://3.138.38.248/Enaam_Backend_V1/public/api/videos', {
            ...
            if (formData.thumbnail) {
                ...
                await axios.post(`http://3.138.38.248/Enaam_Backend_V1/public/api/videos/${response.data.id}/upload-thumbnail`, thumbnailFormData, {
                    headers: {
            ...
            if (formData.video) {
                ...
                await axios.post(`http://3.138.38.248/Enaam_Backend_V1/public/api/videos/${response.data.id}/upload-video`, videoFormData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },

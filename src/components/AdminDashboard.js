...
function AdminDashboard() {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const response = await axios.get('http://3.138.38.248/Enaam_Backend_V1/public/api/admin/users', {
                    headers: {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://3.138.38.248/Enaam_Backend_V1/public/api/admin/users/${id}`, {
